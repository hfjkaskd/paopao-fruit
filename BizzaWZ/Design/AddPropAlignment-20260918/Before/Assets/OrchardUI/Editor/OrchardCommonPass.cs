...
public static class OrchardCommonPass
{
    public static void Apply(GameObject root, string assetPath)
    {
        ...
        switch (Path.GetFileNameWithoutExtension(path))
        {
            ...
            case "RealGamePanel": Paint(root, "BG/Image (2)", "Title"); break;
    ...
    private static void ApplyAddProp(GameObject root)
    {
        ...
        if (limit != null && limit.TryGetComponent<TMP_Text>(out var limitLabel))
        {
            ...
            rect.sizeDelta = new Vector2(650f, 54f);
            rect.anchoredPosition = new Vector2(0f, -568f);
            limitLabel.fontSize = 36f;
            limitLabel.enableAutoSizing = true;
            limitLabel.fontSizeMin = 28f;
            limitLabel.fontSizeMax = 36f;
    ...
    {
        Paint(root, "CurrentGroup/GoldGroup/CoinBox/BG (1)", "Inset");
        Paint(root, "CurrentGroup/DollarGroup/DollarBox/BG", "Inset");
        Paint(root, "CurrentGroup/GoldGroup/ButtonView", "ButtonGreen");
        Paint(root, "CurrentGroup/DollarGroup/ButtonView", "ButtonGreen");
        ...
        PaintPreservingAlpha(root, "CurrentGroup/DollarGroup/DollarBox", "Inset");
        PaintPreservingAlpha(root, "CurrentGroup/DollarGroup/FakeBtn", "ButtonGreen");
        BindExistingButtonGraphic(root, "CurrentGroup/DollarGroup/FakeBtn");
        BindExistingButtonGraphic(root, "CurrentGroup/GoldGroup/RealBtn");
        Body(root, "CurrentGroup/GoldGroup/CoinBox/GoldText");
        Body(root, "CurrentGroup/DollarGroup/DollarBox/DollarText");
        FitCurrencyAmount(root, "CurrentGroup/GoldGroup/CoinBox/GoldText");
        FitCurrencyAmount(root, "CurrentGroup/DollarGroup/DollarBox/DollarText");
        SimpleSprite(root, "CurrentGroup/GoldGroup/ButtonView");
        SimpleSprite(root, "CurrentGroup/DollarGroup/ButtonView");
        Body(root, "CurrentGroup/DollarGroup/Panel/Text (TMP)");
        Title(root, "CurrentGroup/GoldGroup/ButtonView/Text (TMP)");
        Title(root, "CurrentGroup/GoldGroup/ButtonView/Text (TMP) (1)");
        Title(root, "CurrentGroup/DollarGroup/ButtonView/Text (TMP)");
